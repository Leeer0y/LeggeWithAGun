...
class MainMenu(scene.Scene) :
    def __init__(self, screen : pygame.Surface, gamestatemgr) -> None :
        ...
        # Main Menu
        title_text = ui.Text().set_text("Skeleton Vs Zombies").set_font(pygame.font.Font("./Assets/Fonts/RubikPixels-Regular.ttf", 50)).set_anchor(ui.Anchor.CENTER).set_position(pygame.Vector2(screen_center.x, 50))
